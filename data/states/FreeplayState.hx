...
timeTxt = new FunkinText(0, FlxG.height - 60, 400, "X:XX", 32, true);
    ...
    timeBG = new FlxSprite(timeTxt.x + 80,timeTxt.y - 15).makeGraphic(timeTxt.width - 160,timeTxt.height + 40,FlxColor.GRAY);
...
function update(elapsed:Float) {
	...
	var formattedTime = (hours < 10 ? "0" : "" ) + hours + ":" + (minutes < 10 ? "0" : "" ) + minutes + ":" + (seconds < 10 ? "0" : "" ) + seconds + " " + (timeFormat12h ? (hours >= 12 ? "AM" : "PM") : "" );
