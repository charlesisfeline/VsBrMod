...
function onEvent(_) {
    if (_.event.name == 'ZoomCamera') {
        ...
        switch(tweenType.toUpperCase()){
            ...
            case "INSTANT": defaultCamZoom = targetCameraZoom;
            default: zoomTween = FlxTween.tween(this, {defaultCamZoom: targetCameraZoom}, (Conductor.stepCrochet / 1000) * tweenTime, {ease: Reflect.field(FlxEase, tweenType)});
        }
    }
}