            ...
            switch (event.event.params[0]) {
                ...
                case 'Change Character':
                    ...
                    if (Options.colorHealthBar) {
                        ...
                        var rightColor:Int = boyfriend != null
                            && boyfriend.iconColor != null ? boyfriend.iconColor : (PlayState.opponentMode ? 0xFFFF0000 : 0xFF66FF33);
                ...
                case 'Set Property':
                    try {
                        ...
                        trace('ERROR ("Set Property" Event) - ' + e);
...
function postCreate() {
    ...
    for (event in events) {
        switch (event.name) {
            ...
            case 'Play Sound':
                Paths.sound(event.params[1]); // Precache sound
        }
    }
}
