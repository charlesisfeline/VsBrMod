...
function onGameOver() {
    DiscordUtil.changePresence('get breaded', "NO LEAKS");
    // DiscordUtil.changePresence('get breaded', PlayState.SONG.meta.displayName);
}

function onDiscordPresenceUpdate(e) {
    var data = e.presence;
    
    if (data.button1Label == null) data.button1Label = "Vs. br Discord";
    if (data.button1Url == null) data.button1Url = "https://discord.gg/8C8p2jsqK9";
}
...
function onPlayStateUpdate() {
    ...
    /* DiscordUtil.changeSongPresence(PlayState.instance.detailsText,
        ...
        + PlayState.SONG.meta.displayName, PlayState.instance.inst,
        PlayState.instance.getIconRPC());
     */
}
